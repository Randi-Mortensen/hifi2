...
exports.menuselect = function (res, sql, callback) {
    connection.query(sql, function (err, data) {
        if (err) {
            helpers.respond(res, {
                besked: 'Database ikke tilgængelig'
            }, 503);
            return;
        }
        callback(data);
...
// Da der indgår client data i queryen, er der anvendt prepared statements. 
//Der sender de fundne data til callback funktionen hvis brugernavn og kodeord matcher.
...
// session info. Sender data til callback funktionen hvis session_key matcher.
// Ellers sendes et et tom array
